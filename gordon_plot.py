...
subprocess.call('bamCoverage --bam '+str(tax_id)+'/bams/'+pat_id+'.nextseq.sorted.bam -p 48 -o $HOME/'+str(tax_id)+'/beds/'+pat_id+'.nextseq.bed -of bedgraph --binSize 1', shell = True)
